...
const handler = async (m, { conn, text, usedPrefix, command }) => {
 if (!text) throw `التحميل من منصة سبوتيفاي مجانا مثال :\n*spotify2* hello`;
  try {
    ...
    let spotifyi = ` _*التحميل من سبوتيفاي*_\n\n`
        spotifyi += ` ▢ *العنوان:* ${spty.title}\n\n`
        spotifyi += ` ▢ *الفنان:* ${spty.artist}\n\n`
        spotifyi += ` ▢ *الالبوم:* ${spty.album}\n\n`                 
        spotifyi += ` ▢ *تاريخ النشر:* ${spty.year}\n\n`   
        spotifyi += `*[ 🏃 ] جاري ارسال المقطع تابعني هنا ...*\ninstagram.com/noureddine_ouafy`
