...
let handler = async (m, {
    ...
    if (/video/g.test(mime)) {
         return m.reply('لا يدعم استخراج النص من الفيديو')
    }
    if (!/webp|image|viewOnce/g.test(mime)) return m.reply(`هذا الامر خاص باستخراج اي نص اجنبي من اي صورة .سوف تقوم بإرسال اي صورة ثم قم بالاشارة اليها  واكتب \n\n*.ocr*`)
